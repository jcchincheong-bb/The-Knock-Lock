...
constexpr int KNOCK_TOL           = 250;      // How many milliseconds close to target pattern for correct recognition (Higher makes it easier to repeat knock but also less safe)
